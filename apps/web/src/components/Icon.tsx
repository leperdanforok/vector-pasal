/**
 * Lucide-style inline SVG icon set, shared by the chat page and the validity components.
 * Extracted from page.tsx so the source-card family can be reused (e.g. the /dev preview)
 * without duplicating the icon definitions.
 */
